...
import { TipoRecompensaAdmin, LogrosAdmin , DesafiosAdmin, RecompensasAdmin, TablaLideresCRUD } from '@rec-shell/rec-web-gamificacion';
...
const rolePermissions = {
  [ROLES.ADMIN]: {
    ...
    CategoriaComponent: DesafiosAdmin// TipoRecompensaAdmin, //RecompensasCRUD, //TiposDesafioCRUD, //TablaLideresCRUD //DesafiosCRUD //CategoriasList //LogrosCRUD
  },
  [ROLES.MODERATOR]: {
    UserComponent: UserManagement,
