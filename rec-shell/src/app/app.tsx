...
import { TipoRecompensaAdmin, LogrosAdmin , DesafiosCRUD, RecompensasAdmin, TablaLideresCRUD } from '@rec-shell/rec-web-gamificacion';
...
const rolePermissions = {
  [ROLES.ADMIN]: {
    ...
    CategoriaComponent: LogrosAdmin// TipoRecompensaAdmin, //RecompensasCRUD, //TiposDesafioCRUD, //TablaLideresCRUD //DesafiosCRUD //CategoriasList //LogrosCRUD
  },
  [ROLES.MODERATOR]: {
    UserComponent: UserManagement,
