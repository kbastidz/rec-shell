...
import { TipoRecompensaAdmin, LogrosCRUD , DesafiosCRUD, TiposDesafioCRUD, TablaLideresCRUD, RecompensasCRUD, } from '@rec-shell/rec-web-gamificacion';
...
const rolePermissions = {
  [ROLES.ADMIN]: {
    ...
    CategoriaComponent: TipoRecompensaAdmin, //RecompensasCRUD, //TiposDesafioCRUD, //TablaLideresCRUD //DesafiosCRUD //CategoriasList //LogrosCRUD
  },
  [ROLES.MODERATOR]: {
    UserComponent: UserManagement,
