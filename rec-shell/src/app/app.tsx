...
import { Evaluacion } from '@rec-shell/rec-web-educacion';
const ROLES = {
  ADMIN: 'ADMIN',
  MODERATOR: 'MODERATOR'
} as const;
...
const rolePermissions = {
  [ROLES.ADMIN]: {
    AgriculturaComponent: Evaluacion, //GeneradorAdmin, //Evaluacion, //DashboardNotasAcademico, //HistoricoNotasAdmin,//MenuPagueM1,
