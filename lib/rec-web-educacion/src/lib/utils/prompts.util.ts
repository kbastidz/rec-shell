/**
 * Utilidades para generar prompts de Gemini AI
 */

/**
 * Genera el prompt para resumir un documento PDF
 */
...
/**
 * Genera el prompt para crear preguntas de opción múltiple
 * @param summary - El resumen del documento sobre el cual generar las preguntas
 * @param numberOfQuestions - Cantidad de preguntas a generar (por defecto 10)
 */
